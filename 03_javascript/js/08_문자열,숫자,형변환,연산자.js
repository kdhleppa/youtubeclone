...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    console.log( str1.indexOf("가")); // -1 (없는경우 -1반환)
    ...
    // 문자열.split("구분자") : 문자열을 "구분자"로잘라서 배열로 반환
...
document.getElementById("btn2").addEventListener("click", function() {
    ...
    console.log( (4.55).toFixed(0)) ; // 3.5
    console.log( (3.55).toFixed(0)) ; // 3.5
    console.log( (2.55).toFixed(0)) ; // 3.5
    console.log( (1.55).toFixed(0)) ; // 3.5
});
